...
@section('content_header')
    <div class="container-xxl mx-2">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="reconocimientos/create" class="btn btn-success my-3">Nuevo Reconocimiento</a>
        </div>
    </div>
...
<table id="reconocimientos" class="table table-hover table-striped table-bordered shadow-lg  mt-4">
    ...
    <tbody>
        @foreach ($reconocimientos as $reconocimiento)
            <tr>
                <td>{{  $reconocimiento->codigo  }}</td>
                <td>{{  $reconocimiento->cliente->nombre  }}</td>
                <td>{{  $reconocimiento->curso->nombre}}</td>
                
                <td class="text-center">
                    <form action="{{ route('reconocimientos.destroy',$reconocimiento->id) }}" method="POST">
                    <a href="/reconocimientos/{{$reconocimiento->id}}/download" class="btn btn-light btn-sm">
                        ...
                        <a href="{{ route('reconocimientos.show',$reconocimiento->id) }}" class="btn btn-light btn-sm">
