      ...
      <div id="wizard">
        ...
        <section>
          ...
          <div class="purpose-radios-wrapper">
            ...
            <div class="purpose-radio">
              <input type="radio" name="curso" id="curso-{{ $curso->id }}" class="purpose-radio-input " value="{{ $curso->id }}">
              <label for="curso-{{ $curso->id }}" class="purpose-radio-label course">

                @if($curso->imagen)
                <img src="{{ asset('storage/'.$curso->imagen) }}" alt="branding" class="img-thumbnail rounded mx-auto d-block curso-img" border="0">
                @else
                <img src="{{ asset('images/cursos/default-course-img.jpg') }}" alt="branding" class="img-thumbnail rounded mx-auto d-block curso-img" border="0">
                @endif
        ...
        <section>
          ...
          <div class="purpose-radios-wrapper">
            ...
            <div class="purpose-radio">
              <input type="radio" name="design" id="design-{{ $design->id }}" class="purpose-radio-input" value="{{ $design->id }}">
              <label for="design-{{ $design->id }}" class="purpose-radio-label">


                <img src="{{ asset('storage/'.$design->imagen) }}" alt="branding" class="img-thumbnail rounded mx-auto d-block curso-img" border="0">
...
<script>
  ...
  $('#formulario input').on('change', function() {
    curso = $('input[name=curso]:checked', '#formulario').val(); 
    Livewire.emit('cambioCurso',curso);
    console.log(curso);
  });
