                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <h4>Imagen</h4>
                                        <img src="https://png.pngitem.com/pimgs/s/150-1503945_transparent-user-png-default-user-image-png-png.png" alt="Imagen del curso" class=" bg-gray" width="200px">
                                        <div class="mt-3">
                                            <label for="imagen" class="form-label">Seleccionar archivo xd</label>
